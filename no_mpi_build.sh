...
./configure CFLAGS="$CFLAGS" FFLAGS="$FFLAGS" LDFLAGS="$LDFLAGS" CC=$GCC FC=$FC --with-mpi=0 --with-openmp=1 --with-openblas-dir="$CONDA_PREFIX" --prefix="$CONDA_PREFIX" --with-x=0
