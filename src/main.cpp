...
int main(int argc, char** argv) {
    ...
    PetscOptionsString("-inputFilePath","Parquet file with schema: i,j,count","-f",filename, filename, MAXSTRINGLENGTH,&flg);
    PetscOptionsString("-outputFilePath","This will write the U matrix to file","-o",outputUFilePath, outputUFilePath, MAXSTRINGLENGTH,&flg);
    helpOption = PETSC_FALSE;
    PetscOptionsBool("-help", "Display Help Menu", "-h", helpOption, &helpOption, NULL);
    alpha = 0.75;
